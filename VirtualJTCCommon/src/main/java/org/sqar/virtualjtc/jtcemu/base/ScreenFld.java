...
public class ScreenFld
    ...
    public ScreenFld(ScreenControl screenControl, JTCSys jtcSys, int scale) {
    ...
    public void screenConfigChanged() {
        ...
        EventQueue.invokeLater(
                new Runnable() {
                    @Override
                    public void run() {
                        screenControl.screenConfigChanged();
                    }
                });
    }
            ...
            if ((baseW > 0) && (baseH > 0)
                ...
                if (withMarking) {
                    ...
                    if (textSelected != this.textSelected) {
                        ...
                        this.screenControl.setScreenTextSelected(textSelected);
                    }
                }
            }
        }

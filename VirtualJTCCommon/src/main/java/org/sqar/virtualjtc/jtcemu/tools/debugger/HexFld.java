...
public class HexFld extends PlainDocument
    ...
    public HexFld(int maxDigits) {
        ...
        this.mnuCopy = this.popup.add("Kopieren"); // TODO: i18n
        this.mnuPaste = this.popup.add("Einf\u00FCgen"); // TODO: i18n
        this.popup.addSeparator();
        this.mnuReset = this.popup.add("Zur\u00FCcksetzen auf Ursprungswert"); // TODO: i18n

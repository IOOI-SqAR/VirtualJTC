...
public class MemBreakpointDlg
    ...
    private static final String LABEL_TEXT_BEG = "Adresse / Anfangsadresse:"; // TODO: i18n
    private static final String LABEL_TEXT_END = "Endadresse (optional):"; // TODO: i18n
                ...
                if (!endAddrText.isEmpty()) {
                    ...
                    if (endAddr < begAddr) {
                        throw new UserInputException(
                                "Endadresse liegt vor der Anfangsadresse."); // TODO: i18n
                    }
                }
            }
            if (endAddr < 0) {
    ...
    private MemBreakpointDlg(
            Window owner,
            MemBreakpoint breakpoint) {
        super(owner, "Speicherbereich", breakpoint); // TODO: i18n

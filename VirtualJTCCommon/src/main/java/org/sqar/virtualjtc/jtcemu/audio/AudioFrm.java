...
public class AudioFrm
    ...
    public void checkOpenCPUSynchronLine() throws IOException {
        if (this.jtcSys.getZ8().isPause()) {
            throw new IOException("Der emulierte Einchipmikrorechner ist gerade" // TODO: i18n
                    + " auf Pause gesetzt.\n"
    ...
    private AudioFrm(JTCSys jtcSys) {
        ...
        this.loudspeakerFld = new AudioOutFld(
                ...
                true);
        setTitle(AppContext.getAppName() + " Audio/Kassette"); // TODO: i18n
        ...
        // Menu Datei
        JMenu mnuFile = new JMenu("Datei"); // TODO: i18n
        mnuFile.setMnemonic(KeyEvent.VK_D);
        mnuBar.add(mnuFile);

        this.mnuClose = new JMenuItem("Schlie\u00DFen"); // TODO: i18n
        ...
        this.mnuHelpContent = new JMenuItem("Hilfe zu Audio/Kassette..."); // TODO: i18n
    ...
    private void rebuildTabs() {
        ...
        this.tabbedPane.addTab("Eingang Kassette", this.tapeInFld); // TODO: i18n
        if (this.jtcSys.supportsLoudspeaker()) {
            this.tabbedPane.addTab("Ausgang Kassette", this.tapeOutFld); // TODO: i18n
            this.tabbedPane.addTab("Lautsprecher", this.loudspeakerFld); // TODO: i18n
        } else {
            this.tabbedPane.addTab(
                    "Ausgang Kassette / Lautsprecher", // TODO: i18n
                    this.tapeOutFld);
            }

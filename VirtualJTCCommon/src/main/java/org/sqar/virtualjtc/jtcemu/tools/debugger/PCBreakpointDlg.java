...
public class PCBreakpointDlg extends AbstractBreakpointDlg {
    private static final String LABEL_TEXT = "Adresse:"; // TODO: i18n
    ...
    private PCBreakpointDlg(Window owner, PCBreakpoint breakpoint) {
        super(owner, "Programmadresse", breakpoint); // TODO: i18n
        ...
        this.tglEnabled = new JCheckBox("Haltepunkt aktiviert"); // TODO: i18n

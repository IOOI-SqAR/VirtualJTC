...
public class AudioInFld
    ...
    public AudioInFld(AudioFrm audioFrm, JTCSys jtcSys, String propPrefix) {
        ...
        panelFct.setBorder(BorderFactory.createTitledBorder("Funktion")); // TODO: i18n
        add(panelFct, gbc);
        ...
        this.btnFromLine = new JRadioButton(
                "Audiodaten vom Sound-System (z.B. Mikrofonanschluss) lesen", // TODO: i18n
                true);
        grpFct.add(this.btnFromLine);
        panelFct.add(this.btnFromLine, gbcFct);

        this.btnFromFile = new JRadioButton(
                "Audiodaten aus Sound- oder Tape-Datei lesen"); // TODO: i18n
        ...
        this.btnFromLastFile = new JRadioButton(
                "Letzte Sound- oder Tape-Datei noch einmal lesen"); // TODO: i18n
        ...
        panelOpt.setBorder(BorderFactory.createTitledBorder("Optionen")); // TODO: i18n
        gbc.gridy++;
        add(panelOpt, gbc);
        ...
        this.labelChannel = new JLabel("Aktiver Kanal:"); // TODO: i18n
        gbcOpt.gridy++;
        panelOpt.add(this.labelChannel, gbcOpt);

        this.labelThreshold = new JLabel("Schwellwert [%]:"); // TODO: i18n
        ...
        this.btnChannel0 = new JRadioButton("Links", true); // TODO: i18n
        grpChannel.add(this.btnChannel0);
        panelChannel.add(this.btnChannel0, gbcChannel);

        this.btnChannel1 = new JRadioButton("Rechts"); // TODO: i18n
        ...
        this.tglMonitor = new JCheckBox("Mith\u00F6ren"); // TODO: i18n
        ...
        panelStatus.setBorder(BorderFactory.createTitledBorder("Status")); // TODO: i18n
        gbc.gridy++;
        add(panelStatus, gbc);
        ...
        this.labelFile = new JLabel("Datei:"); // TODO: i18n
        panelStatus.add(this.labelFile, gbcStatus);

        this.labelFormat = new JLabel("Format/L\u00E4nge:"); // TODO: i18n
        gbcStatus.gridy++;
        panelStatus.add(this.labelFormat, gbcStatus);

        this.labelProgress = new JLabel("Fortschritt:"); // TODO: i18n
        ...
        this.btnEnable = new JButton("Aktivieren"); // TODO: i18n
        panelBtn.add(this.btnEnable);

        this.btnDisable = new JButton("Deaktivieren"); // TODO: i18n
        panelBtn.add(this.btnDisable);

        this.btnPlay = new JButton("Abspielen"); // TODO: i18n
        panelBtn.add(this.btnPlay);

        this.btnPause = new JButton("Pause"); // TODO: i18n
        panelBtn.add(this.btnPause);

        this.btnMaxSpeed = new JButton("Turbo"); // TODO: i18n
        panelBtn.add(this.btnMaxSpeed);


        // Pegelanzeige
        this.volumeBar = new VolumeBar();
        this.volumeBar.setBorder(BorderFactory.createTitledBorder("Pegel")); // TODO: i18n
        ...
        if (this.audioIn == null) {
            if (file == null) {
                file = FileDlg.showFileOpenDlg(
                        this.audioFrm,
                        "Sound-/Tape-Datei \u00F6ffnen", // TODO: i18n
                        "\u00D6ffnen", // TODO: i18n
    ...
    private void fileDropped(File file) {
        if (this.audioIn != null) {
            showErrorDlg("Sie m\u00FCssen zuerst die Audiofunktion" // TODO: i18n
                    + " deaktivieren,\n"
    ...
    private void setMaxSpeed(boolean state) {
        SpeedControl speedControl = Main.getTopFrm();
        if (speedControl != null) {
            if (state) {
                AudioIn audioIn = this.audioIn;
                if (audioIn != null) {
                    if (audioIn instanceof AudioInFile) {
                        if (speedControl.setMaxSpeed(this, true)) {
                ...
                if (this.maxSpeedTriggered) {
                    speedControl.setMaxSpeed(this, false);
                    this.maxSpeedTriggered = false;
                }
            }
        }

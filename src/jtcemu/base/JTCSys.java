                        ...
                        Z8PCListener
{
  ...
  public JTCSys() throws IOException
  {
    ...
    this.u883rom             = readFile( "/rom/u883rom.bin" );
    this.os2k_0800           = readFile( "/rom/os2k_0800.bin" );
    this.es1988_0800         = readFile( "/rom/es1988_0800.bin" );
    this.es1988_2000         = readFile( "/rom/es1988_2000.bin" );
    this.es23_0800           = readFile( "/rom/es23_0800.bin" );
    this.es40_0800           = readFile( "/rom/es40_0800.bin" );
  ...
  public void settingsChanged()
  {
    ...
    String text   = Main.getProperty( "jtcemu.os" );
    if( text != null ) {
    ...
    int ramSize = 0x10000;
    text        = Main.getProperty( "jtcemu.ram.size" );
    if( text != null ) {
      if( text.equals( "1K" ) ) {
        ramSize = 0x0400;

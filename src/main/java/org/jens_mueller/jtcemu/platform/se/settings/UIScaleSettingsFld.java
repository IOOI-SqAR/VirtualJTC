...
public class UIScaleSettingsFld extends JPanel implements ActionListener
{
  ...
  public UIScaleSettingsFld( SettingsFrm settingsFrm )
  {
    ...
    add(
	new JLabel( "Ab Java 9 k\u00F6nnen die "
    ...
    this.rbScaleNone = new JRadioButton( "Keine Skalierung" );
    ...
    if( !JTCUtil.isWinOS() ) {
      gbc.gridy++;
      add(
	new JLabel( "Achtung! Auf diesem Betriebssystem hier"
    ...
    gbc.gridy++;
    add(
	new JLabel( "Achtung! Die Einstellungen auf dieser Unterseite"

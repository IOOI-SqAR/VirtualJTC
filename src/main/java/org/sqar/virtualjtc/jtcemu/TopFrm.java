...
import org.sqar.virtualjtc.jtcemu.tools.*;
import org.sqar.virtualjtc.jtcemu.tools.hexedit.*;
                                ...
                                DropTargetListener
{
  ...
  {
    boolean state = true;
    if( Main.getBooleanProperty( "org.sqar.virtualjtc.jtcemu.confirm.init", true ) ) {
  ...
  {
    boolean state = true;
    if( Main.getBooleanProperty( "org.sqar.virtualjtc.jtcemu.confirm.reset", true ) ) {
  ...
  {
    Main.setProperty(
        "org.sqar.virtualjtc.jtcemu.screen.scale",
  ...
  {
    boolean state = true;
    if( Main.getBooleanProperty( "org.sqar.virtualjtc.jtcemu.confirm.quit", true ) ) {
      if( JOptionPane.showConfirmDialog(
                this,
  ...
  {
    return Main.getIntProperty( "org.sqar.virtualjtc.jtcemu.screen.refresh.ms", 50 );
  }
  ...
  private boolean updScreenSize( boolean updScale )
  {
    ...
    int mNew = Main.getIntProperty( "org.sqar.virtualjtc.jtcemu.screen.margin", 20 );

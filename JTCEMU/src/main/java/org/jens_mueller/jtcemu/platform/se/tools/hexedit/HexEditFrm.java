...
{
  private static final String FILE_GROUP = "hexeditor";
  ...
  public void actionPerformed( ActionEvent e )
  {
	...
	HelpFrm.open( "/help/se/hexeditor.htm" );
      } else {
  ...
  private HexEditFrm()
  {
    ...
    this.mnuHelpContent = createJMenuItem( "Hilfe zum Hex-Editor..." );
  ...
  private void doBytesSave()
  {
	...
	if( presetDir == null ) {
	  presetDir = AppContext.getLastDirFile( FILE_GROUP );
	}

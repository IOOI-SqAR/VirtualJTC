				...
				MouseListener
{
  ...
  public void actionPerformed( ActionEvent e )
  {
	...
	HelpFrm.open( "/help/se/debugger.htm" );
  ...
  {
    setTitle( AppContext.getAppName() + " Debugger" );
    this.z8               = z8;
    ...
    this.mnuAddPCBreakpoint = createJMenuItem(
			"Haltepunkt auf PC-Adresse hinzuf\u00FCgen...",
			KeyEvent.VK_F9, 0 );
    mnuDebug.add( this.mnuAddPCBreakpoint );

    this.mnuAddMemBreakpoint = createJMenuItem(
			"Haltepunkt auf Speicher hinzuf\u00FCgen..." );
    mnuDebug.add( this.mnuAddMemBreakpoint );

    this.mnuAddRegBreakpoint = createJMenuItem(
			"Haltepunkt auf Register hinzuf\u00FCgen..." );
    mnuDebug.add( this.mnuAddRegBreakpoint );

    this.mnuBreakpointEdit = createJMenuItem( "Haltepunkt bearbeiten..." );
    mnuDebug.add( this.mnuBreakpointEdit );

    this.mnuBreakpointRemove = createJMenuItem(
			"Haltepunkt entfernen",
			KeyEvent.VK_DELETE, 0 );
    mnuDebug.add( this.mnuBreakpointRemove );

    this.mnuBreakpointRemoveAll = createJMenuItem(
			"Alle Haltepunkte entfernen" );
    mnuDebug.add( this.mnuBreakpointRemoveAll );
    mnuDebug.addSeparator();

    this.mnuBreakpointEnable = createJMenuItem( "Haltepunkt aktivieren" );
    mnuDebug.add( this.mnuBreakpointEnable );

    this.mnuBreakpointDisable = createJMenuItem( "Haltepunkt deaktivieren" );
    mnuDebug.add( this.mnuBreakpointDisable );

    this.mnuBreakpointEnableAll = createJMenuItem(
			"Alle Haltepunkte aktivieren" );
    mnuDebug.add( this.mnuBreakpointEnableAll );

    this.mnuBreakpointDisableAll = createJMenuItem(
    ...
    this.mnuHelpContent = new JMenuItem( "Hilfe zum Debugger..." );
    ...
    this.popupBreakpointAdd = createJMenuItem(
    ...
    this.labelRegSelection = new JLabel( "Register anzeigen:" );
    ...
    panelCycles.add( new JLabel( "Interne Taktzyklen:" ), gbcCycles );
    ...
    this.btnCyclesReset = new JButton( "Zur\u00FCcksetzen" );
    ...
    panelBreakpoint.add( new JLabel( "PC-Adresse" ), gbcBreakpoint );
    gbcBreakpoint.gridx++;
    panelBreakpoint.add( new JLabel( "Speicher" ), gbcBreakpoint );
    gbcBreakpoint.gridx++;
    panelBreakpoint.add( new JLabel( "Register" ), gbcBreakpoint );
